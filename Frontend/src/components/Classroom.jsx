...
const Classroom = () => {
  ...
  useEffect(() => {
    ...
    const useDummyData = () => {
      ...
      setClassrooms([
        { id: 1, name: "Room 101", type: "Lecture Hall" },
        { id: 2, name: "Room 102", type: "Computer Lab" },
        { id: 3, name: "Room 103", type: "Seminar Room" },
        { id: 4, name: "Room 104", type: "Laboratory" },
      ]);
      ...
      // Dummy schedule data for different groups on Thursday with expanded time range
      setAllSchedules([
        // Group 1 schedules
        {
          group_id: 1,
